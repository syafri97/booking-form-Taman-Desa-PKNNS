...
// ✅ Fix CORS untuk localhost & Render
const allowedOrigins = [
    'http://localhost:3000', // Untuk localhost
    'https://booking-form-taman-desa-pknns.onrender.com' // Untuk render.com
];

// Middleware untuk CORS
app.use((req, res, next) => {
    const origin = req.headers.origin;
    // Pastikan origin dibenarkan
...
// Fungsi untuk menulis teks panjang dalam PDF
...
// Fungsi untuk menghasilkan PDF yang diisi dengan data
async function generateFilledPdf(templatePath, data) {
    ...
    // Pilih template untuk setiap borang
    switch (templatePath) {
    ...
    // Mengisi data dalam template PDF
...
// Endpoint untuk menghantar borang tempahan
app.post('/submitBooking', async (req, res) => {
    ...
    try {
        ...
        // Hapuskan fail selepas dihantar
